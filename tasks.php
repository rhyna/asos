...
- в шапке в админке не отображается активный раздел
- переделать все кейсы с ошибками на try catch по аналогии с edit-brand.php
- переделать все Exception на Throwable
- переделать обработку ошибок на try-catch в файлах delete по примеру как в delete-brand.php
    (добавить классы с типом Exception)